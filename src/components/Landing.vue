...
export default {
  ...
  methods: {
    ...
    handleMouseMove(e) {
      ...
      // دوران 3D حوالين X و Y
      const rotateY = offsetX / 40; // يمين/شمال
      const rotateX = -offsetY / 40; // فوق/تحت

      // حركة بسيطة translate (طفو)
      const moveX = offsetX / 15; // يمين/شمال
      const moveY = offsetY / 15; // فوق/تحت
