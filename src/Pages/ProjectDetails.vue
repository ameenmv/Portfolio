  ...
  <div class="bg-[var(--bg)] min-h-[100vh] text-[var(--white)]">
    ...
    <div class="containerr min-h-[100vh] !pt-[160px] !pb-[100px]">
      <div class="w-[100%] flex justify-center flex flex-col items-center">
        ...
        <p
          class="mt-5 font-bold text-[17px] text-[var(--white)] opacity-[.8] w-[70%] text-center leading-[1.5]"
        >
          {{ project.title }}
        </p>
        <iframe
        ...
        <div class="flex mt-20 gap-10 w-[100%]">
          <div class="left w-[60%]">
            ...
            <p class="font2 mt-4 leading-[1.6]">
              This journey was full of learning, deep research, and challenges.
              I learned a lot during my training at ITI, and even more while
              building this project from scratch. The UI & UX design is
              completely my own creation and vision.
            </p>
            ...
            <p class="font2 mt-4 leading-[1.6]">
              Frontend: Vue.js, Tailwind CSS, Vuelidate, Pinia, Axios
              <br />Backend: Laravel API, Laravel ORM, Laravel Sanctum
              <br />
              Database: MySQL
            </p>
          </div>
          <div class="right w-[40%] px-8">
            <p class="font-bold text-[18px] text-[var(--sc)]">
              Project Highlights
            </p>
            <p
              class="mt-4 pb-4 border-b border-[#3741517d] font2 leading-[1.6]"
            >
              Engineered complex, high-performance animations using GSAP
              (GreenSock Animation Platform) for seamless transitions and
...
.left button:hover {
  background: rgba(31, 41, 55, 0.683);
  border-color: rgb(67, 79, 98);
  .arrow {
